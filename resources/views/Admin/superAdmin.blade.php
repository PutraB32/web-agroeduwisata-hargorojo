...
<body class="bg-gray-50 flex h-screen overflow-hidden text-neutral font-sans">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-white flex flex-col shadow-2xl md:shadow-lg border-r border-gray-200 z-50 transform -translate-x-full md:relative md:translate-x-0 transition-transform duration-300 ease-in-out shrink-0">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-1.5 no-scrollbar">
            ...
            <a href="javascript:void(0)" onclick="tampilkanPanel('kategori', this)" class="menu-link w-full flex items-center gap-3 px-4 py-2.5 rounded-r-lg text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-primary transition-colors border-l-4 border-transparent">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div id="panel-dashboard" class="crud-panel">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                            <div class="w-12 h-12 bg-yellow-50 text-secondary rounded-full flex items-center justify-center text-xl mb-4 border border-yellow-100"><i class="fas fa-book-open"></i></div>
                            <h3 class="text-2xl font-black text-gray-800">{{ $katalogs->total() }}</h3>
                            <p class="text-gray-500 text-sm font-medium mt-1">Total Data Katalog Desa</p>
                        </div>
                        <div class="bg-white border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                            <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center text-xl mb-4 border border-blue-100"><i class="fas fa-users"></i></div>
                ...
                @include('Admin.partials.kategori_crud')
